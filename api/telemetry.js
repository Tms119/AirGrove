...
<head>
  ...
  <title>AirGrove Live Status</title>
  <style>
    * { box-sizing: border-box; margin: 0; padding: 0; }
    body { font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif; background: #06090e; color: #e2e8f0; padding: 40px 20px; }
    ...
    .card { background: #0f172a; border: 1px solid rgba(255,255,255,0.08); border-radius: 18px; padding: 22px; }
    ...
    .privacy-notice { background: rgba(255,255,255,0.03); border: 1px solid rgba(255,255,255,0.06); border-radius: 16px; padding: 16px 20px; font-size: 13px; color: #94a3b8; display: flex; align-items: center; gap: 10px; }
  </style>
</head>
<body>
  <div class="container">
    <div style="margin-bottom: 24px; overflow: hidden;">
      <a href="/api/stats?format=html" class="btn-refresh">↻ Refresh</a>
      <h1>🌿 AirGrove Live Status</h1>
      <p class="subtitle">Real-time aggregate peer-to-peer transfer metrics</p>
    </div>
    ...
    <div class="privacy-notice">
      <span>🔒</span>
      <div><strong>Privacy Protected:</strong> Individual transfer details, filenames, and connection logs are private and only visible to the project owner in the Vercel Runtime Logs dashboard.</div>
    </div>
  </div>
</body>
</html>
