...
Important: AirGrove connects directly over your local network. Both devices should be connected to the same Wi-Fi router (not cellular data). For best results, use **Safari** or **Chrome** (other browsers like Brave can block the connection).
